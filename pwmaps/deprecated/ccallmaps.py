...
def run(playwright: Playwright) -> None:
    ...
    while noEnd:
        ...
        time.sleep(4)   # slow down python loop using time.sleep(): https://stackoverflow.com/a/16555131
        ...
        nextArticle = page.wait_for_selector(f'[role="article"] >> nth={len(articleList)+1}', timeout=120000) # wait max 2min

    ...
    while noEnd:
        ...
        # exception based on PlaywrightTimeoutError: https://playwright.dev/python/docs/api/class-timeouterror
            ...
            if pageEndElem:
                ...
                print(f'FINISHED {searchRegion} without result because of TimeoutError')
                with open(f'{targetGroup}_{searchRegion}_error.html', 'w') as f:   #TODO: add date & time prefix to document name

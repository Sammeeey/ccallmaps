    ...
    while noEnd:
        ...
        try:
            ...
            try:
                ...
                logging.exception("Found a save button - seems to be a single-page result...")
        ...
        # exception based on PlaywrightTimeoutError: https://playwright.dev/python/docs/api/class-timeouterror
            ...
            logging.exception('Seemingly didn\'t find end of article list\n') # logging including error message: https://stackoverflow.com/a/5191885
            lastArticle.element_handle().scroll_into_view_if_needed()

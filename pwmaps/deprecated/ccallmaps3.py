...
def run(playwright: Playwright) -> None:
    ...
    counter = 0 # counter used to determine how many times loop has been repeated (max 1 time) - to avoid endless loop because of list end already there but not checked correctly (see try...except in while loop)
    while noEnd:
        counter += 1
